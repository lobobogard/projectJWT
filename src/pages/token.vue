  ...
  <div>
    ...
    <div class="row q-mt-md justify-center text-white">
      <div class="col-9 bg-teal-10 shadow-3 q-pl-md q-pr-sm q-pt-sm q-pb-sm">
        ...
        C) The <b>"token refresh"</b> is generated in a cookie handling an expiration time of <b>20 minutes</b> for the purpose of separate tests. It handles other extra safeguards such as Httponly and SameSmite of strict type.<br>
        D) The <b>"token"</b> is stored in the session storage has <b>1 minutes</b> of expiration after expire will be renove the token and cookie and not logout for that.
      </div>
    </div>
    <div class="row q-mt-md justify-center text-white">
